...
Check the [releases](https://github.com/droboports/wget/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/wget.git
cd wget
./build.sh
```
